...
function BanditUtils.Hit(shooter, item, victim, damageSplit)
    ...
    if SurvivorCompanions and SurvivorCompanions.GetSkillLevel and brainShooter then
        sightCharacter = sightCharacter + (SurvivorCompanions.GetSkillLevel(brainShooter, "firearms") * 0.6)
    end
