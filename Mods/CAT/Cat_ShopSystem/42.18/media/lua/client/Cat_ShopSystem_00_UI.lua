...
function Cat_ShopClaimUI:createChildren()
    ...
    local title = ISLabel:new(10, 10, 20, "SHOP SHELF", 1, 1, 1, 1, UIFont.Medium, true)
    title:initialise()
    self:addChild(title)

    local info = ISLabel:new(10, 40, 18, "This shelf is unclaimed.", 0.8, 0.8, 0.8, 1, UIFont.Small, true)
    info:initialise()
    self:addChild(info)
