...
function FAM_TriagePanel:renderVirologyStatus(y)
    ...
    self:drawText(formatText("IGUI_FAM_ZVV_Inventory", asTextInt(counts.syringes), asTextInt(counts.blood), asTextInt(counts.vaccines), asTextInt(counts.tubes), asTextInt(counts.brain)), 24, y + 110, COLORS.dim.r, COLORS.dim.g, COLORS.dim.b, 1, UIFont.Small)
