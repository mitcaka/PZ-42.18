...
function ISUnloadBulletsFromMagazine:animEvent(event, parameter)
	...
	elseif event == 'RemoveBullet' then
		...
		local itemKey = FWPConsumeLoadedAmmoForUnload and FWPConsumeLoadedAmmoForUnload(self.magazine, FWPGetAmmoItemKey(self.magazine)) or FWPGetAmmoItemKey(self.magazine)
